...
+function($, window){
  ...
  canya.parallax = function() {
    ...
    $('[data-parallax]').each(function() {
      ...
      options = $.extend( options, canya.getDataOptions(parallax));
  ...
  canya.map = function() {
    ...
    $('[data-provide~="map"]').each(function() {
      ...
      setting = $.extend(setting, canya.getDataOptions($(this)));
  ...
  canya.carousel = function() {
    ...
    $('.swiper-container').each(function(){
      ...
      options = $.extend( options, canya.getDataOptions(swiper));
  ...
  canya.typed = function() {
    ...
    $('[data-type]').each(function(){
      ...
      options = $.extend( options, canya.getDataOptions(el) );
  ...
  //
  canya.getDataOptions = function(el, castList) {
    var options = {};

    $.each( $(el).data(), function(key, value){

      key = canya.dataToOption(key);
  ...
  //
  canya.optionToData = function(name) {
  ...
  //
  canya.dataToOption = function(name) {
