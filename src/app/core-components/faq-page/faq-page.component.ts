...
export class FaqPageComponent implements OnInit {
  faqs = [
      ...
      {q: "Who is a 'provider'?",a:"A 'provider' is anyone offerring services via the CanYa Ecosystem."},
      ...
      {q: "Why do I have to use CAN?",a:"CAN token can be used within our ecosystem for purchases or jobs, CAN can also be converted to and from Ethereum."},
