...
export class FaqPageComponent implements OnInit {
  faqs = [
    ...
    },
    {
      ...
      a: 'CAN token is the native token of the CanYa Ecosystem, providing a bridge between other currencies. The CAN token is integrated into the hedged escrow, ensuring that all transactions on the platform are hedged and free from price volatility. For a global freelance marketplace $CAN is also useful as its value remains universal across the globe and can be sent to anyone, anywhere at any time.'
    },
    {
      index: 'q-8',
    ...
    },
    {
      ...
      a: 'Use metamask for payments. Here is a guide to set up a MetaMask wallet: https://medium.com/canyacoin/setting-up-a-metamask-wallet-to-use-with-canwork-151ed877ac54'
    },
    {
      index: 'q-18',
    ...
    },
    {
      ...
      a: 'Yes! However providers will be screened through the CanYa support for quality assurance.'
    },
    {
      index: 'q-20',
